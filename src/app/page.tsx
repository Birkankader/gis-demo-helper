...
export default function HomePage() {
  ...
  const handleDrawBbox = useCallback(() => {
    // Close sidebar on mobile so the map is fully visible for drawing
    ...
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 relative">
          ...
          {/* Mobile floating draw button */}
          <div className="lg:hidden absolute bottom-4 left-4 z-[1000] flex flex-col gap-2">
            <button
              onClick={handleDrawBbox}
            ...
            {state.bbox && (
              <button
                onClick={handleClearBbox}
                className="w-12 h-12 rounded-full bg-destructive text-destructive-foreground shadow-lg flex items-center justify-center active:scale-95 transition-transform"
